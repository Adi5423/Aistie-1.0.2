Just a testing for the main Aistie Final launch , i used Groq API Service to test how API's work how to work with them not gonna be using someone's else API Key for our product.
